\section{Grundlagen}
   ...
   \lstset{language=PHP} 
	...
	Hier kommt wirklich nur der Entwurf rein, also wie ich mir die Funktionsweise der Software vorstelle. Dazu muss ich vielleicht meine Diagramme ändern oder vereinfachen.
